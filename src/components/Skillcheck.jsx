...
const SkillCheck = ({ character }) => {
  ...
  const performSkillCheck = () => {
    ...
    const skillModifier = character.skills[selectedSkill] + Math.floor((character.attributes[SKILL_LIST.find(skill => skill.name === selectedSkill).attributeModifier] - 10) / 2);
